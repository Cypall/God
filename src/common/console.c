...
static void display_title(void)
{
	...
	ShowMessage("\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"                                                    "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"            God Development Team presents           "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"                _______            _                "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"               /  _____|          | |               "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"               | |  ___  ___   ___| |               "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"               | | /_  |/ _ \\/  _   |               "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"               | |___| / /_/ | (_|  |               "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"               \\______/\\____/\\____/|/               "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"                                                    "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"                 http://www.god.com                 "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_YELLOW"                                                    "CL_CLL""CL_NORMAL"\n");
